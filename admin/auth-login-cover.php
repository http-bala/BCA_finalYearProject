  ...
  <div class="authentication-inner row">
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4 mx-auto">
      <div class="w-px-400 mx-auto">
        ...
        <!-- /Logo -->
        <h3 class="mb-1">Welcome to Admin Panel 👋</h3>
...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Dec 2023 07:20:21 GMT -->
</html>
