      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Admin/</span>DETAILS </h4>
            ...
            <table id="example" class="table table-striped table-bordered dataTable display" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                ?><tr>
                      ...
                      <td><a type="button" class="btn btn-success" href="edit-company.php?sid=<?php echo $data['id']; ?>"><i class="fa-solid fa-trash"></i></a>
                        <a class="btn btn-danger" href="delete-company.php?sid=<?php echo $data['id']; ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                      </td>
                    </tr>
                <?php
                  }
