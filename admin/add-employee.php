...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">ADD-</span>EMPOLYEE</h4>
                                    ...
                                    <div class="card-body">
                                        <form class="row g-3 needs-validation" novalidate autocomplete="off" id="submit-form" >
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="fname" name="empname" placeholder="Employee Name" required>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="validationCustom02" class="form-label">Employee Code</label>
                                                <input type="text" class="form-control" id="empcode" name="empcode"  placeholder="Employee Code" readonly  required>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="text" class="form-control" id="empusername" name="empusername" aria-describedby="inputGroupPrepend" placeholder="Username" required>
                                                </div>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom03" class="form-label">designation</label>
                                                <input type="Email" class="form-control" id="email" name="empdesignation" placeholder="designation"  required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="password" name="emppassword" placeholder="Password"  required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom03" class="form-label">Department</label>
                                                <input type="Email" class="form-control" id="phone" name="empdepartment" placeholder="Department"  required>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="State" name="emppan" placeholder="PAN Number" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Date of Birth</label>
                                                <input type="date" class="form-control" id="zipcode" name="empdob" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Date of joining</label>
                                                <input type="date" class="form-control" id="zipcode" name="empdoj" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Mail id</label>
                                                <input type="email" class="form-control" id="zipcode" name="empmail" placeholder="Mail id"  required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Bank Name</label>
                                                <input type="email" class="form-control" id="zipcode" name="empbankname" placeholder="Bank Name"  required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Bank A/C no</label>
                                                <input type="email" class="form-control" id="zipcode" name="empbankac" placeholder="Bank A/C no" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Total Pays Days</label>
                                                <input type="email" class="form-control" id="zipcode" name="empTPD" placeholder="Total pays days" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Basic Salary</label>
                                                <input type="email" class="form-control" id="zipcode" name="empbasicSalary" placeholder="Basic Salary" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label for="validationCustom05" class="form-label">Profile Image</label>
                                                <input type="file" class="form-control" id="zipcode" name="profile" required>
                                            </div>
        ...
        function empcode() {
            $val = "EMP-"+ Math.floor(Math.random()*10000);
            let empcode = document.getElementById("empcode");
            empcode.setAttribute("value",$val)
        }
        empcode();
            // Flat pickr
