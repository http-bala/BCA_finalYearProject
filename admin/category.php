    ...
    <!-- Navbar -->
        ...
        <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <!-- respone msg -->
                        <div id="msg"></div>
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">ADD-</span>Category</h4>
                        <!-- Basic Layout -->
                        <div class="row w-75 m-auto ">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Add-Category</h5> <small class="text-muted float-end">Details</small>
                                    </div>
                                    <div class="card-body">
                                        <form class="row g-3 needs-validation" novalidate autocomplete="off">
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="catname" placeholder="category" required autofocus>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-4 ">
                                                <button class="btn btn-primary" id="sbtn" type="submit">Add</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        while ($data = mysqli_fetch_assoc($result)) {
            ?><tr>
                ...
                <td><a type="button" class="btn btn-success" href="edit-company.php?sid=<?php echo $data['id']; ?>">update</a>
          <a class="btn btn-danger" href="delete-category.php?sid=<?php echo $data['id']; ?>">delete</a></td>
              </tr> 
            <?php
        }
      }
            ...
            <div class="container-xxl">
              <div class="footer-container d-flex align-items-center justify-content-center py-2 flex-md-row flex-column">
                <div>
                  ...
                  </script>, made with ❤️ by <a href="https://pixinvent.com/" target="_blank" class="fw-medium">balakrishna</a>
                </div>
...
sbtn.addEventListener("click", (e) => {
                ...
                xhr.open("POST", "insert-category.php", true)
